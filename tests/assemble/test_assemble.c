...
void test_assembly(void)
{
	...
	TEST_ASSERT_EQUAL_INT16(ADDR_MODE_INDIRECT_Y_INDEXED, addr_mask);

	instr->addr_bitflag = addr_mask & instr->addr_bitfield;
	TEST_ASSERT_EQUAL_INT16(ADDR_MODE_INDIRECT_Y_INDEXED, instr->addr_bitflag);
	...
	TEST_ASSERT_EQUAL_INT16(0xA4, assemble_LDY(ADDR_MODE_ZERO_PAGE));
